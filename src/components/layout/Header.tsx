...
export function Header({ isMenuOpen, onMenuOpenChange }: HeaderProps) {
  return (
    <>
      <header className="h-16 bg-white/80 backdrop-blur-sm border-b border-gray-200 fixed top-0 right-0 left-0 z-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              <h1 className="text-xl font-bold text-primary-600">스마트팜 허브</h1>
